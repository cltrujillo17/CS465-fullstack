export const trips = [
  ...
  },
  {
    ...
    "length": "3 nights",
    "start": "2026-08-10",
    "resort": "Travlr Keys Resort",
    "perPerson": "$999",
    "image": "images/reef3.jpg",
    "description": "<p>Florida Keys Donec sed felis risus. Nulla facilisi. Donec a orci tellus, et auctor odio. Fusce ac orci nibh, quis semper arcu. Cras orci neque, euismod et accumsan ac, sagittis molestie lorem. Proin odio sapien, elementum at tempor non.</p><p>Vulputate eget libero. In hac habitasse platea dictumst. Integer purus justo, egestas eu consectetur eu, cursus in tortor. Quisque nec nunc ac mi ultrices iaculis.</p>"
  }
];